					...
					<div class="col-sm-12">
						...
						<form method="post" action="#" id="loginForm">
							<div class="form-group">
								<label>您的手机号<span style="color: red;">*</span></label> <input
									type="text" id="loginTel" name="phone" class="form-control">
							</div>
							<div class="form-group">
								<label>您的密码<span style="color: red;">*</span></label> <input
...
<a href="#" class="reg-btn" data-toggle="modal" data-target="#regModal">注册</a>
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<form method="post" action="#" id="regForm">
							<div class="form-group">
								<label>您的姓名</label> <input type="text" id="regName" name="userName"
							...
							<div class="form-group">
								<label>您的邮箱<span style="color: red;">*</span></label> <input
									type="text" id="regEmail" name="email" class="form-control">
							</div>
							<div class="form-group">
								<label>您的公司<span style="color: red;">*</span></label> <input
							...
							<div class="form-group">
								<input type="button" class="btn btn-primary modal-btn" onclick="register()" value="注册" />
							</div>
						</form>
					</div>
				</div>
