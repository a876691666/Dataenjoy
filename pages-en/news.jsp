...
<body>
			...
			<nav class="navbar navbar-inverse" role="navigation">
				<div id="main-nav" class="collapse navbar-collapse navStyle">
					<ul class="nav navbar-nav" id="mainNav">
						...
						<li class="active"><a href="#" class="scroll-link">News</a></li>
					</ul>
					<div class="btn-box">
	...
	<!--Hero_Section-->
     <form action="<%=request.getContextPath()%>/newsController/list.do" method="post" id="searchForm">
	<section id="aboutUs">
		<!--Aboutus-->
		<div class="inner_wrapper">
			<div class="container container_inner">
				...
				<div class="news_section">
					...
					<div class="row news">
					  <div class="news-img col-lg-3 col-sm-3">
					    <img alt="" src="<%=request.getContextPath()%>/res/images/dynamic/pic01.jpg" width="200" height="160"/>
					  </div>
					  <div class="news-info col-lg-9 col-sm-9">
					   <h3>${item.title}</h3>
					   <p>${item.content}
					   </p>
					   <div class="col-lg-12 col-sm-12 news_bottom">
					     <span class="news_date">${item.insTime}</span>
					     <a href="<%=request.getContextPath()%>/newsController/get.do?newsId=${item.newsId}" class="more"data-toggle="modal" data-target="#regModal">More></a>
					   </div>
					  </div>
					</div>
					</c:forEach>
